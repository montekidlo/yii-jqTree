  ...
  JqTreeWidget = (function(_super) {
    ...
    JqTreeWidget.prototype._refreshElements = function(from_node) {
      ...
      createNodeLi = function(node) {
        var escaped_name, node_id;
        escaped_name = escapeIfNecessary(node.name);
        node_id = (node.id != undefined) ? ' id="'+node.id+'" ' :'';
        return $("<li"+node_id+"><div><span class=\"title\">" + escaped_name + "</span></div></li>");
      };
      createFolderLi = function(node) {
        var button_class, escaped_name, folder_class, getButtonClass, getFolderClass, node_id;
